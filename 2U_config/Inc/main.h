...
#define TX_UART3V3_MOBCtoCOBC_Pin GPIO_PIN_2
#define TX_UART3V3_MOBCtoCOBC_GPIO_Port GPIOA
#define TX_SOFTUART_MOBCtoTXPIC_Pin GPIO_PIN_2
#define TX_SOFTUART_MOBCtoTXPIC_GPIO_Port GPIOH
#define RX_SOFTUART_TXPICtoMOBC_Pin GPIO_PIN_3
#define RX_SOFTUART_TXPICtoMOBC_GPIO_Port GPIOH
...
#define RX_UART3V3_COBCtoMOBC_Pin GPIO_PIN_3
#define RX_UART3V3_COBCtoMOBC_GPIO_Port GPIOA
#define GPIO3V3_MOBCtoCOBC_1_Pin GPIO_PIN_4
#define GPIO3V3_MOBCtoCOBC_1_GPIO_Port GPIOA
#define CS_SPI3V3_MOBCtoSUNSPZ_Pin GPIO_PIN_5
#define CS_SPI3V3_MOBCtoSUNSPZ_GPIO_Port GPIOA
#define GPIO3V3_COBCtoMOBC_1_Pin GPIO_PIN_6
#define GPIO3V3_COBCtoMOBC_1_GPIO_Port GPIOA
#define CS_SPI3V3_MOBCtoSUNSMY_Pin GPIO_PIN_7
#define CS_SPI3V3_MOBCtoSUNSMY_GPIO_Port GPIOA
...
#define CTL_OD3V3_MOBCtoMUX_ANAS_Pin GPIO_PIN_15
#define CTL_OD3V3_MOBCtoMUX_ANAS_GPIO_Port GPIOI
#define CTL_OD3V3_MOBCtoMUX_TEMS_Pin GPIO_PIN_0
#define CTL_OD3V3_MOBCtoMUX_TEMS_GPIO_Port GPIOJ
#define A0_OD3V3_MOBCtoMUX_Pin GPIO_PIN_1
#define A0_OD3V3_MOBCtoMUX_GPIO_Port GPIOJ
#define A1_OD3V3_MOBCtoMUX_Pin GPIO_PIN_2
#define A1_OD3V3_MOBCtoMUX_GPIO_Port GPIOJ
#define A2_OD3V3_MOBCtoMUX_Pin GPIO_PIN_3
#define A2_OD3V3_MOBCtoMUX_GPIO_Port GPIOJ
#define A3_OD3V3_MOBCtoMUX_Pin GPIO_PIN_4
#define A3_OD3V3_MOBCtoMUX_GPIO_Port GPIOJ
#define A4_OD3V3_MOBCtoMUX_Pin GPIO_PIN_11
#define A4_OD3V3_MOBCtoMUX_GPIO_Port GPIOF
...
#define GPIO3V3_COBCtoMOBC_2_Pin GPIO_PIN_12
#define GPIO3V3_COBCtoMOBC_2_GPIO_Port GPIOE
#define GPIO3V3_MOBCtoCOBC_2_Pin GPIO_PIN_13
#define GPIO3V3_MOBCtoCOBC_2_GPIO_Port GPIOE
...
#define TX_UART3V3_MOBCtoTXPIC_Pin GPIO_PIN_10
#define TX_UART3V3_MOBCtoTXPIC_GPIO_Port GPIOB
#define RX_UART3V3_TXPICtoMOBC_Pin GPIO_PIN_11
#define RX_UART3V3_TXPICtoMOBC_GPIO_Port GPIOB
...
#define D9_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_7
#define D9_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOH
#define RESET3V3_MOBCtoCOBC_Pin GPIO_PIN_8
#define RESET3V3_MOBCtoCOBC_GPIO_Port GPIOH
#define A0_3V3_MOBCtoADC_ACS1_Pin GPIO_PIN_9
#define A0_3V3_MOBCtoADC_ACS1_GPIO_Port GPIOH
#define AB_3V3_MOBCtoADC_ACS1_Pin GPIO_PIN_10
#define AB_3V3_MOBCtoADC_ACS1_GPIO_Port GPIOH
#define BYTESWAP3V3_MOBCtoADC_ACS1_Pin GPIO_PIN_11
#define BYTESWAP3V3_MOBCtoADC_ACS1_GPIO_Port GPIOH
#define RESET3V3_MOBCtoADC_ACS1_Pin GPIO_PIN_12
#define RESET3V3_MOBCtoADC_ACS1_GPIO_Port GPIOH
...
#define D0_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_14
#define D0_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOB
#define D1_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_15
#define D1_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOB
#define D2_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_8
#define D2_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOD
#define D3_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_9
#define D3_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOD
#define D4_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_10
#define D4_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOD
...
#define D5_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_6
#define D5_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOG
#define D6_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_7
#define D6_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOG
#define D7_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_8
#define D7_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOG
#define TX_SOFTUART_MOBCtoRXPIC_Pin GPIO_PIN_6
#define TX_SOFTUART_MOBCtoRXPIC_GPIO_Port GPIOC
#define RX_SOFTUART_RXPICtoMOBC_Pin GPIO_PIN_7
#define RX_SOFTUART_RXPICtoMOBC_GPIO_Port GPIOC
#define D8_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_8
#define D8_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOC
#define SDA_I2C3V3_MOBCto9AXDAC_Pin GPIO_PIN_9
#define SDA_I2C3V3_MOBCto9AXDAC_GPIO_Port GPIOC
#define SCL_I2C3V3_MOBCto9AXDAC_Pin GPIO_PIN_8
#define SCL_I2C3V3_MOBCto9AXDAC_GPIO_Port GPIOA
#define TX_UART3V3_MOBCtoRXPIC_Pin GPIO_PIN_9
#define TX_UART3V3_MOBCtoRXPIC_GPIO_Port GPIOA
#define RX_UART3V3_RXPICtoMOBC_Pin GPIO_PIN_10
#define RX_UART3V3_RXPICtoMOBC_GPIO_Port GPIOA
...
#define D12_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_13
#define D12_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOH
#define D13_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_14
#define D13_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOH
#define D14_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_15
#define D14_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOH
#define D15_3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_0
#define D15_3V3_ADC_ACS1toMOBC_GPIO_Port GPIOI
#define BUSY3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_1
#define BUSY3V3_ADC_ACS1toMOBC_GPIO_Port GPIOI
#define EOC3V3_ADC_ACS1toMOBC_Pin GPIO_PIN_2
#define EOC3V3_ADC_ACS1toMOBC_GPIO_Port GPIOI
...
#define GPIO3V3_MOBCtoCOBC_3_Pin GPIO_PIN_7
#define GPIO3V3_MOBCtoCOBC_3_GPIO_Port GPIOK
...
#define CS_SPI3V3_MOBCtoSUNSPX_Pin GPIO_PIN_4
#define CS_SPI3V3_MOBCtoSUNSPX_GPIO_Port GPIOI
#define CS_SPI3V3_MOBCtoSUNSPY_Pin GPIO_PIN_5
