...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void HardFault_Handler_Debug(uint32_t *pulFaultStackAddress){
  printf("\r\n\r\nHard-fault detected!\r\n\r\n");
...
//  printf("lr, sp = %08x, %08x\r\n", lr, sp);
//  uint32_t p_SCB_HFSR = 0xE000ED2C;
//  uint32_t SCB_HFSR = *(uint32_t*)p_SCB_HFSR;
//  uint32_t p_SCB_CFSR = 0xE000ED28;
//  uint32_t SCB_CFSR = *(uint32_t*)p_SCB_CFSR;
//  printf("SCB_HFSR = %08x\r\n", SCB_HFSR);
//  printf("SCB_CFSR = %08x\r\n", SCB_CFSR);
//  printf("cmd_id = %d\r\n", CCP_get_id(PL_get_head(task_dispathcer->tskd.pl)->packet));
//  if(CCP_get_id(PL_get_head(task_dispathcer->tskd.pl)->packet) == Cmd_CODE_BCE_COMBINE_BLOCK){
...
//  printf("HardFault\r\n");
  ...
  __asm volatile("B HardFault_Handler_Debug");
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(GPIO3V3_SOBCtoMOBC_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(DIO3_3V3_LORAtoMOBC_Pin);
  HAL_GPIO_EXTI_IRQHandler(RESET3V3_MOBCtoGYRO_Pin);
  HAL_GPIO_EXTI_IRQHandler(OSC32_IN_Pin);
