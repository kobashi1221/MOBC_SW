...
// for MAGNARO2 3U SOLIDWORKSから出力(20240706時点仮決定)
static const float Inertia_tensor_ini[3][3] = { {0.048413577f,   0.000084384f,  -0.000065184f},
                                                {0.000084384f,   0.051865010f,  -0.000112071f},
                                                {-0.000065184f, -0.000112071f,   0.011880463f}};
...
// for MAGNARO2 2U SOLIDWORKSから出力(20240706時点仮決定)
static const float Inertia_tensor_ini_2U[3][3] = { {0.015235991f,   -0.000354177f,  0.000226696f},
                                                   {-0.000354177f,   0.016852458f, -0.000111090f},
                                                   {0.000226696f,   -0.000111090f,  0.006913339f}};
//static const float maglimit_[3] = {0.2f, 0.2f, 2.5f}; // for MAGNARO
static const float maglimit_[3] = {0.37f, 0.37f, 4.464f}; // JMAGより
#endif
...
// for MAGNARO2 1U SOLIDWORKSから出力(20240706時点仮決定)
static const float Inertia_tensor_ini_1U[3][3] = { {0.003909389f,   0.000437456f,  0.000241379f},
                                                   {0.000437456f,   0.005734765f,  0.000059696f},
                                                   {0.000241379f,   0.000059696f,  0.004957282f}};
//static const float maglimit_[3] = {0.15f, 0.15f, 2.5f}; // for MAGNARO
static const float maglimit_[3] = {0.37f, 0.17f, 2.4f}; // JMAGより
...
void AOCS_DRIVER_Mode_Set(uint32_t AOCS_DRIVER_Mode_Num){
    GAP.AOCS_MODE.AOCS_DRIVER_MODE_Number = AOCS_DRIVER_Mode_Num;
}
...
uint32_t AOCS_DRIVER_Mode_Get(void){
    return g_sensor.p_GLOBAL_AOCS->AOCS_MODE.AOCS_DRIVER_MODE_Number;
}
