...
#define PH_TLC_TLM_LIST_MAX   (TL_TLM_PAGE_SIZE * 2)
#ifdef TLCD_ENABLE_MISSION_TL
#define PH_TLC_MIS_LIST_MAX   (TL_TLM_PAGE_SIZE * 2)   // とりあえず TL_DEPLOY_BC, TL_DEPLOY_TLM と同じ長さにした
#endif
#define PH_RT_TLM_LIST_MAX    (10)
#ifdef DR_ENABLE
#define PH_ST_TLM_LIST_MAX    (24)
