...
public:
	 ...
	 */
	MCP23017(); //empty constructor kishi add
	MCP23017(uint8_t address, void* bus);
	~MCP23017();
	uint8_t getDeviceAddress(void); //kishi add
	void* getHandleI2C(void); //kishi add
	void setDeviceAddress(uint8_t address); //kishi add
	void setHandleI2C(void* bus); //kishi add
	 ...
	 */
	MCP23017PortACK portMode(MCP23017Port port, uint8_t directions, uint8_t pullups = 0xFF, uint8_t inverted = 0x00);
	/**
	 ...
	 */
	MCP23017PortACK pinMode(uint8_t pin, uint8_t mode, bool inverted);
	 ...
	 */
	MCP23017PortACK digitalWrite(uint8_t pin, uint8_t state);
	/**
	 ...
	 */
	MCP23017PortACK writeRegister(MCP23017Register reg, uint8_t value);
	/**
	 ...
	 */
	MCP23017PortACK writeRegister(MCP23017Register reg, uint8_t portA, uint8_t portB);
	/**
